        ...
        <form @submit.prevent="saveChanges">
          <div class="form-group">
            ...
            <input
              ...
              class="form-input"
            />
            <small class="error" v-if="title.errorValue !== ''">{{
              title.errorValue
            }}</small>
          </div>
          <div class="form-group">
            ...
            <textarea
              ...
              class="form-input"
            ></textarea>
            <small class="error" v-if="description.errorValue !== ''">{{
          ...
          <div class="form-group">
            ...
            <input
              id="url"
              type="text"
              v-model="editedMovie.url"
              class="form-input"
            />
            <small class="error" v-if="url.errorValue !== ''">{{
              url.errorValue
            }}</small>
          </div>
...
onMounted(() => {
  if (route.state?.movie) {
    ...
    movie.value = storedMovies.find(
      (film) => film.id === Number(route.params.id)
    )
  }
